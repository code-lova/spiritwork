...
<body class="body1 b-bg1">
                ...
                <div class="row align-items-center">
                    <div class="col-lg-2 col-md-6 col-6">
                        <div class="vl-logo">
                            <a href="{{ route('homepage') }}">
                                <img src="{{ asset('uploads/logofav/'. $logo->logo) }}"
                        ...
                        <div class="vl-main-menu text-center">
                            <nav class="vl-mobile-menu-active">
                                <ul>
                                    ...
                                    <li class="has-dropdown">
                                        <a href="{{ route('user.create.reports') }}">Create Report</a>
                                    </li>
                                    <li class="has-dropdown">
                    ...
                    <div class="col-lg-2 col-md-6 col-6">
                        <div class="vl-hero-btn d-none d-lg-block text-end">
                            <div class="btn-area1">
                                <a href="{{ route('logout') }}" class="vl-btn1"
            ...
            <div class="vl-offcanvas-wrapper">
                <div class="vl-offcanvas-header d-flex justify-content-between align-items-center mb-90">
                    <div class="vl-offcanvas-logo">
                        <a href="index.html"><img src="{{ asset('uploads/logofav/'. $logo->logo2) }}" alt="{{ $settings->site_name }}"></a>
                    </div>
    ...
    @include('inc.homepages.otherpage_footer')
