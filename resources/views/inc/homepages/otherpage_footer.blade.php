      ...
      <div class="row">
        <div class="col-lg-10 m-auto">
            <div class="heading1 text-center">
              <h2>Find Your Perfect Rental with OCHeaven Homes</h2>
              <div class="space16"></div>
              <p>At OCHeaven Homes, we don’t just rent spaces — we create comfortable, stylish living experiences. <br class="d-lg-block d-none"> Explore our collection of quality homes and discover a rental process that’s simple, personal, <br class="d-lg-block d-none"> and designed with your lifestyle in mind.</p>
              <div class="space32"></div>
              <div class="btn-area1">
                <a href="{{ route('properties') }}" class="vl-btn1">Find Your New Home <span class="arrow1"><i class="fa-solid fa-arrow-right"></i></span><span class="arrow2"><i class="fa-solid fa-arrow-right"></i></span></a>
              </div>
            </div>
        </div>
      </div>
